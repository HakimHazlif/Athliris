      ...
      <div className="inline-flex gap-4 items-start">
        <div className="relative flex justify-center items-start mt-1 ">
          <Field
            ...
            name={id}
            id={id}
            className="peer w-[17px] h-[17px] opacity-0 absolute z-20 cursor-pointer"
          />
          <FaCheck className="peer-checked:opacity-100 opacity-0 absolute z-10" />
          <div className="w-4 h-4 peer-checked:bg-neon-400 border-2 border-gray-300 peer-checked:border-neon-400 rounded-sm flex justify-center items-center cursor-pointer absolute z-0"></div>
        </div>
        <label
          htmlFor={id}
