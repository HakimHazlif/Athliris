...
import { logOut } from '../features/auth/service/apiAuth'
...
const UserPanel = () => {
  ...
  return (
    <aside className="w-72 h-screen bg-white dark:bg-grayish-500 shadow-md py-7 px-5 text-sm flex flex-col">
      <div className="flex-1">
        ...
        <div className="py-10 flex flex-col">
          ...
          <div className="mt-10 h-full flex-1">
            <div className="flex justify-between items-center">
              <h3>Reminders</h3>
              <FiBell size={18} />
            </div>
